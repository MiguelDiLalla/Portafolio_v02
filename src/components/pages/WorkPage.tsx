  ...
  const projects = [
    {
      ...
      description: "An endless scrolling art gallery that breaks the boundaries of traditional portfolios.",
      tech: ["React", "Motion", "WebGL"],
      gradient: "from-rose-400 to-orange-300"
    },
    {
      title: "Fluid Navigation",
      description: "Revolutionary navigation system that adapts to user behavior and content flow.",
      tech: ["TypeScript", "CSS3", "Intersection Observer"],
      gradient: "from-blue-400 to-purple-300"
    },
    {
      title: "Immersive Stories",
      description: "Interactive storytelling platform with gesture-based navigation and spatial audio.",
      tech: ["Three.js", "Web Audio API", "Canvas"],
      gradient: "from-green-400 to-cyan-300"
    },
    {
      title: "Dynamic Layouts",
      description: "Self-organizing content system that creates unique layouts based on user interaction patterns.",
      tech: ["Machine Learning", "D3.js", "React"],
      gradient: "from-purple-400 to-pink-300"
    },
    {
      title: "Spatial Interface",
      description: "3D web interface that responds to device orientation and creates immersive browsing experiences.",
        ...
        >
          <div className="max-w-4xl mx-auto grid md:grid-cols-2 gap-12 items-center px-8">
            ...
            <div className="relative">
              ...
              <div className="aspect-video bg-white/20 backdrop-blur-sm rounded-xl p-6 border border-white/30">
                <div className="w-full h-full bg-gradient-to-br from-white/30 to-transparent rounded-lg flex items-center justify-center">
                  <div className="text-center">
                    ...
                    <div className="text-sm opacity-70">Interactive Preview</div>
                  </div>
                </div>
              </div>
